    ...
    public partial class CourseAndStudent : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseAndStudent", x => new { x.CourseId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_CourseAndStudent_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseAndStudent_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAndStudent_StudentId",
                table: "CourseAndStudent",
                column: "StudentId");
        }
